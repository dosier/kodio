...
/**
 * macOS implementation of local Whisper engine.
 * 
 * TODO: Implement using whisper.cpp native bindings.
 */
actual object WhisperLocalEngine {
    
    actual fun create(model: WhisperModel, modelPath: String?): TranscriptionEngine = 
        MacosWhisperLocalEngine(model, modelPath)
...
private class MacosWhisperLocalEngine(
    ...
    override fun transcribe(
        ...
        TranscriptionResult.Error(
            message = "Local Whisper inference is not yet implemented on macOS. " +
