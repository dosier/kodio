...
/**
 * iOS implementation of local Whisper engine.
 * 
 * TODO: Implement using whisper.cpp iOS bindings or Core ML.
 */
actual object WhisperLocalEngine {
    
    actual fun create(model: WhisperModel, modelPath: String?): TranscriptionEngine = 
        IosWhisperLocalEngine(model, modelPath)
...
private class IosWhisperLocalEngine(
    ...
    override fun transcribe(
        ...
        TranscriptionResult.Error(
            message = "Local Whisper inference is not yet implemented on iOS. " +
