...
/**
 * Android implementation of local Whisper engine.
 * 
 * TODO: Implement using whisper.cpp Android bindings or ONNX Runtime.
 */
actual object WhisperLocalEngine {
    
    actual fun create(model: WhisperModel, modelPath: String?): TranscriptionEngine = 
        AndroidWhisperLocalEngine(model, modelPath)
    
    actual val isSupported: Boolean = false
    
    actual suspend fun downloadModel(model: WhisperModel, onProgress: ((Float) -> Unit)?): Boolean {
        // TODO: Implement model download to app's files directory
        return false
    }
    
    actual fun isModelDownloaded(model: WhisperModel): Boolean {
        // TODO: Check for downloaded models in app's files directory
        return false
    }
}

private class AndroidWhisperLocalEngine(
    ...
    override fun transcribe(
        ...
        TranscriptionResult.Error(
            message = "Local Whisper inference is not yet implemented on Android. " +
